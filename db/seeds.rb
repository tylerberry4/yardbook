...
Student.create(
    fname: 'Mason',
    lname: 'Whitaker',
    blurb: "Is an 18-year-old (young) front-end designer and recent high-school graduate with a passion for entrepreneurship and programming. He is committed to his education and will be starting college at Appalachian State in the fall as a business major. He hopes the skills he’s gaining at The Iron Yard will help him with his goal of being an entrepreneur. You can follow his career at masonwhitaker.com.",
    github_url: 'maswhitaker@github.com',
    twitter_url: 'site@twitter.com',
    linkedin_url: 'site@linkedin.com',
    image_url: 'site@github.com',
    webpage: 'site@site.com',
...
Student.create(
    fname: 'Justin',
    lname: 'Parker',
    blurb: "Grew up in a small town in the country and worked in the deli of a grocery store. While in college, he made a career out of giving customers the best product by preparing food and making suggestions for a great meal. His sister went to college in New York City and through visiting her his conduit to culture opened up. His visits to the city made him realize how amazing culture is, how diversely food could be prepared, and how fast technology is growing, which inspired him to learn to use technology to its full potential.",
    github_url: 'jparker85@github.com',
    twitter_url: 'site@twitter.com',
    linkedin_url: 'site@linkedin.com',
    image_url: 'site@github.com',
    webpage: 'site@site.com',
...
Student.create(
    fname: 'Josh',
    lname: 'Tarkington',
    blurb: "Is an aspiring writer and is a third of the way through his first book which he plans to finish as a trilogy and has another story ready to go as a movie script. He has degree in geology and held an internship with Charlotte-Mecklenburg Stormwater before joining The Iron Yard.",
    github_url: 'ichus@github.com',
    twitter_url: 'site@twitter.com',
    linkedin_url: 'site@linkedin.com',
    image_url: 'site@github.com',
    webpage: 'site@site.com',
...
Student.create(
    ...
    github_url: 'chetcorey@github.com',
    twitter_url: 'site@twitter.com',
    linkedin_url: 'site@linkedin.com',
    image_url: 'site@github.com',
    webpage: 'site@site.com',
...
Student.create(
    fname: 'Brian',
    lname: 'D',
    blurb: 'Brian is the youngest student to attend The Iron Yard. He is 13 years old and heading into his first year of high school. Brian’s family and teachers were looking to provide him with a much needed academic challenge that would satisfy his curiosity with programming. Brian is an exceptionally bright young man. Keep a look out for Brian’s future - he’s scheduled to graduate high school in 2018.',    github_url: 'site@github.com',
    github_url: 'briardes@github.com',
    twitter_url: 'site@twitter.com',
    linkedin_url: 'site@linkedin.com',
    image_url: 'site@github.com',
    webpage: 'site@site.com',
...
Student.create(
    ...
    github_url: 'sebarmano@github.com',
    twitter_url: 'site@twitter.com',
    linkedin_url: 'site@linkedin.com',
    image_url: 'site@github.com',
    webpage: 'site@site.com',
...
Admin.create(
    fname: 'Ruthan',
    lname: 'Freese',
    blurb: 'Before joining the Ruby on Rails course as a TA, Ruthan was an intern for Open Software Integrators. She has also worked for TechShop, Inc. Fun Fact: She was a volunteer exactor for the inaugural season of the ‘Ayn Gharandal Archaeological Project.',
    github_url: 'therufs@github.com',
    twitter_url: 'site@twitter.com',
    linkedin_url: 'site@linkedin.com',
    image_url: 'site@github.com',
    webpage: 'site@site.com',
...
Admin.create(
    fname: 'Clinton',
    lname: 'Dreisbach',
    blurb: 'afasdfsdgsdasdsdsadasasdsadds',
    github_url: 'cndreisbach@github.com',
    twitter_url: 'site@twitter.com',
    linkedin_url: 'site@linkedin.com',
    image_url: 'site@github.com',
    webpage: 'site@site.com',
...
Admin.create(
    ...
    lname: 'Elman',
    blurb: 'afasdfsdgsdasdsdsadasasdsadds',
    github_url: 'juliaelman@github.com',
    twitter_url: 'site@twitter.com',
    linkedin_url: 'site@linkedin.com',
    image_url: 'site@github.com',
    webpage: 'site@site.com',
